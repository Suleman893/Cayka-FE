...
//Reusable Component
import DeviceAction from '@components/analytics/generalAnalytics/table/actions/DeviceAction'
...
const DeviceTable = () => {
  ...
  return (
    <Table
      isLoading={isLoading}
      columns={columns}
      actions={<DeviceAction title='Devices List' />}
      filters={<DeviceFilter setPage={setPage} setFilters={setFilters} />}
