...
import AppLogo from '@core/svg/AppLogo'
import WebLogo from '@core/svg/WebLogo'
...
const Navigation = props => {
  ...
  return (
    ...
    >
      ...
      <NavHeader>
        <Link href='/'>{isCollapsed && !isHovered ? <AppLogo/> : isCollapsed && isHovered ? <WebLogo /> : <WebLogo />}</Link>
